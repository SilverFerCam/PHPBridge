...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/loader.css?v=<?php echo time(); ?>">   
...
<body>
    ...
    <div class="barra">
        ...
        <a class="derecha">Digital Transformation Maturity Quick Scan</a>
    </div>
    ...
    <div class="cuestionario" id="quiz">        
        <form>
            ...
            <div id="p12" class="p12 pregunta">
                <h3>12. Supplier Management: To what extent are key suppliers managed appropriately to support the seamless provision of quality products and services?</h3>
                <div class="respuestas">
            ...
            <div id="p20" class="p20 pregunta">
                <h3>20. To what extent does my organization apply improvement methodologies, culture and techniques, in alignment with our strategic objectives?</h3>
                <div class="respuestas">
...
<script src="js/progressbar.js?v=<?php echo time(); ?>"></script>
<script src="js/portada.js?v=<?php echo time(); ?>"></script>
<script src="js/contraportada.js?v=<?php echo time(); ?>"></script>
